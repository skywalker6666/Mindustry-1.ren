...
import { ModalHeader, ModalBody, ModalFooter, Collapse, CardBody, Card } from 'reactstrap';
import ResizeObserver from 'resize-observer-polyfill';
import styled, { css, ThemeProvider } from 'styled-components';
import debug from 'debug';
import { Checkbox, Menu, MenuItem, Breadcrumbs, PopoverPosition, Breadcrumb, Tooltip, Hotkey, Hotkeys, HotkeysTarget, Dialog, Classes, ContextMenuTarget, PopoverInteractionKind, Popover, Position, Drawer, Tabs, Divider, Button, NumericInput, InputGroup, Tab, Alert,Modal} from '@blueprintjs/core';
...
import { UploadFiles,returnNodeNumber,exportSubconceptTitleToFirebase,loadSubconceptTitleFromFirebase,loadSubconceptContentFromFirebase,loadSubconceptQuestionFromFirebase,loadSubconceptAnswerFromFirebase,loadFileNameFromFirebase } from '../../../../src/utils';
import { getUpdatedSubconceptTitleCondition } from'../../../../src/component/toolbar/toolbar-item-save';
...
function RenderingPlugin() {
    ...
    return {
        ...
        renderDiagramCustomize: function (props) {
            ...
            var leftTopPanel = controller.run('renderLeftTopPanel',nProps);
            var preProcessPanel=controller.run('renderPreProcessPanel',nProps);
            ...
            return [breadcrumbs, rightTopPanel,leftTopPanel,preProcessPanel, modals, drawer, viewportViewer];
        },
...
var templateObjectQQ;

var Panel2 = styled(ZIndex)(templateObjectQQ || (templateObjectQQ = __makeTemplateObject(["\n  position: absolute;\n  background: white;\n right: 0px;\n width: 250px;\n height: 50%;\n  top: 0px;\n  border-radius: 2px;\n  user-select: none;\n"], ["\n  position: absolute;\n  background: blue;\n  left: 30px;\n  top: 20px;\n  border-radius: 2px;\n  user-select: none;\n"])));

function LeftTopPanel(props) {
  ...
  //  alert("QQQ");
    ...
    return (createElement(Panel2, {
       ...
       // return( createElement('div',{title:"ILOVEYOU"})
        createElement(Title, null,
            createElement(CloseIcon, {
         //       className: iconClassName(IconName.CLOSE),
                onClick: function () {
      ...
      //  return( createElement(InputGroup, null)
        , controller.run('renderLeftTopPanelTabs',props))));
}


var templateObjectQA;
var Panel3 = styled(ZIndex)(templateObjectQA || (templateObjectQA = __makeTemplateObject(["\n  position: absolute;\n  background: red;\n left: 150px;\n width: 50%;\n height: 50%;\n  top: 0px;\n  border-radius: 2px;\n  user-select: none;\n"], ["\n  position: absolute;\n  background: red;\n  left: 50px;\n  top: 50px;\n  border-radius: 2px;\n  user-select: none;\n"])));

export function PreProcessPanel(props) {
    var controller = props.controller,
    zIndex = props.zIndex,
    selectedTabId = props.selectedTabId,
    handleTabIdChange = props.handleTabIdChange;
var _a = __read(useState(false), 2),
    ...
    return (createElement(Panel3, {
            id: 'moveBar',
            zIndex: zIndex,
            // style:{display:'none'}
        },createElement('div',{id:'banner', style:{height: '30px'}},
            createElement('div',{},'膽案',),
                createElement(CloseIcon,{
                    className: iconClassName(IconName.CLOSE),
                    onClick: function(){
            ...
            createElement('div',{style:{background: 'white'}},
...
////////改改改改改
function FileBufferEditor(props){
    var tabsProps = {
        id: tabId,
        handleTabIdChange: function (id) {
            tabId = id;
...
var global_subconceptTitle,global_nodeName,global_subconceptQuestion,global_subconceptAnswer,global_subconceptContent;
...
function MetadataEditor(props) {
    ...
    // var updated_nodeNumOfsubconceptTitle=returnNodeNumber();
    // var updated_mapNameOfsubconceptTitle=loadFileNameFromFirebase();
    
    var updated_mapNameOfsubconceptTitle = controller.getValue(PropKey.TOPIC_TITLE, __assign(__assign({}, props), { topicKey: model.rootTopicKey }));
    var updated_nodeKeyOfsubconceptTitle=topicKey;console.log("updated_nodeKeyOfsubconceptTitle: "+updated_nodeKeyOfsubconceptTitle);
    var updated_subconceptTitle=loadSubconceptTitleFromFirebase(updated_mapNameOfsubconceptTitle,updated_nodeKeyOfsubconceptTitle);
    var updated_subconceptQuestion=loadSubconceptQuestionFromFirebase(updated_mapNameOfsubconceptTitle,updated_nodeKeyOfsubconceptTitle);
    var updated_subconceptAnswer=loadSubconceptAnswerFromFirebase(updated_mapNameOfsubconceptTitle,updated_nodeKeyOfsubconceptTitle);
    var updated_subconceptContent=loadSubconceptContentFromFirebase(updated_mapNameOfsubconceptTitle,updated_nodeKeyOfsubconceptTitle);

    // var [subconceptObject,setNewSubconcept]=useState();
    var [subconceptTitle,setSubconceptTitle]=useState(updated_subconceptTitle||"");
    var [subconceptContent,setSubconceptContent]=useState(updated_subconceptContent||"");
    var [question,setQuestion]=useState(updated_subconceptQuestion||"");
    var [answer,setAnswer]=useState(updated_subconceptAnswer||"");
    var tabsProps = {
        id: tabId,
        handleTabIdChange: function (id) {
            tabId = id;
     ...
     // var title = controller.run('getTopicTitle', props)
    var title = controller.getValue(PropKey.TOPIC_TITLE, __assign(__assign({}, props), { topicKey: topicKey }))
    global_nodeName=title;
    // var title = controller.getValue(PropKey.TOPIC_TITLE, __assign({}, props));
    
    // var setSubcontent = function (style) {
    //     controller.run('setTopicContentStyle', __assign(__assign({}, props), {
    //         style: style
    //     }));
    // };
    ...
    var AnswerChange = function (e) {
        setAnswer(e.target.value);
    }; 
    var SubcontentTitleChange = function (e) {      
        setSubconceptTitle(e.target.value);
    }; 
    var SubcontentChange = function (e) {      
        setSubconceptContent(e.target.value);
    }; 
    
    var subContentTitleProps = {
        value:subconceptTitle,
        onChange: SubcontentTitleChange
    }; 
    var subContentProps = {
        value:subconceptContent,
        onChange: SubcontentChange
    }; 
    var questionProps = {
        value:question,
    ...
    global_subconceptTitle=subconceptTitle;
    global_subconceptQuestion=question;
    global_subconceptAnswer=answer;
    global_subconceptContent=subconceptContent;
    var noteEditor = createElement(SettingItem, null,
        createElement(Flex, {
                alignItems: "center"
            },
            createElement(Margin, {
            ...
            createElement(InputGroup, __assign({},subContentProps))));
    var questionEditor = createElement(SettingItem, null,
            ...
            createElement(InputGroup, __assign({},questionProps)),

            createElement(Margin, {
                margin: "0 5px 0 0"
            }, "答案: "),
            createElement(InputGroup,__assign({},answerProps) )
            ));
    var MetadataObject=createElement(PanelTabRoot, null,
        createElement(SettingGroup, null,
            createElement(SettingItem, null,
                createElement(Flex, {
                        alignItems: "center"
        ...
        createElement(SettingGroup, null,
            ...
            createElement(SettingBoxContainer, null,
                createElement(InputGroup, __assign({},subContentTitleProps)),
                createElement(Tabs, __assign({}, tabsProps),
                    createElement(Tab, {
                        id: "normal",
                        title: "筆記",
        ...
        const AddNewSubconcept =()=> {      
            console.log("中出來");
            subconceptTitle=prompt("新的子概念標題:");
            alert(subconceptTitle);
            return(
            '<div className="blog__controller"><Button variant="outline-danger">刪除</Button></div>'
            )
        }
        var btn=createElement(Button,{
            id:"add_subconcept",
            title:"Add",
            onClick:AddNewSubconcept,
        },"新增");
        
          
        return  MetadataObject,btn;
}
function ReturnSubcontentTitle(){return global_subconceptTitle};
function ReturnSubconceptContent(){return global_subconceptContent};
function ReturnSubcontentQuestion(){return global_subconceptQuestion};
function ReturnSubcontentAnswer(){return global_subconceptAnswer};
function ReturnNodeName(){return global_nodeName};
...
var add=createElement(IconBg,{OnClick: function(){}},createElement(ShowMenuIcon, {className: iconClassName(IconName.PLUS)}));
/////////////////////////////
var addfileclick=2;
function LeftTopPanelPlugin() {
    // alert("KKK");
    var selectedTabId = 'topic-style';
    var handleTabIdChange = function (tabId) {
        selectedTabId = tabId;
    ...
    return {
        renderLeftTopPanel: function (props) {
            var nProps = __assign(__assign({}, props), {
                key: 'left-top-panel',
                // selectedTabId: selectedTabId,
                // handleTabIdChange: handleTabIdChange
            });
             //   return createElement(LeftTopPanel)
             return createElement(LeftTopPanel, __assign({}, nProps));
        },
        renderLeftTopPanelTabs: function (props) {
            var controller = props.controller;
            var FileBufferTab = controller.run('renderFileBuffer', props);
            return FileBufferTab;
        },
        renderFileBuffer: function (props) {
            ...
            var tProps = {
                ...
                panel:  
                    createElement(Button,{
                    onClick: function(){
                        UploadFilesToStorage(Title);
                        //parent.location.reload();
                    },
                    className: iconClassName(IconName.PLUS)
                    },filepanel(0))
            };
            return createElement(Tab,__assign({}, tProps)
...
function filepanel(n){
    var kk=createElement(ShowMenuIcon, {
        className: iconClassName(IconName.OPEN_FILE)});
    for (var i=0;i<n;i++){             
      kk=kk+','+(createElement(ShowMenuIcon, {
          className: iconClassName(IconName.OPEN_FILE)}));
    }                
    return kk;
}
...
function PreProcessPlugin() {
    //  alert("KKKAAAA");
      ...
      return {
          renderPreProcessPanel: function (props) {
              var nProps = __assign(__assign({}, props), {
                  key: 'preprocess-panel',
                  // selectedTabId: selectedTabId,
                  // handleTabIdChange: handleTabIdChange
              });
              return createElement(PreProcessPanel, __assign({}, nProps));
          },
          renderPreProcessPanelTabs: function (props) {
              var controller = props.controller;
              var PreProcessBufferTab = controller.run('renderPreProcessPanelBuffer', props);
              return PreProcessBufferTab;
          },
          renderPreProcessPanelBuffer: function (props) {
              var n=0;
              var tProps = {
                  id: 'preprocess-buffer',
                  key: 'PreProcess-buffer',
                  title: 'PreProcessBuffer',
                  panel:  
...
export {
    ...
    topicRefKey,
    topicWidgetRefKey,
    ReturnSubcontentTitle,
    ReturnSubcontentQuestion,
    ReturnSubcontentAnswer,
    ReturnSubconceptContent,
    ReturnNodeName
};
