...
var TopicContentWidget = /** @class */ (function (_super) {
    ...
    TopicContentWidget.prototype.render = function () {
        ...
        return (createElement(TopicContentWithDropArea, null,
            prevDropArea,
            createElement(TopicContent$1, __assign({
                    style: topicStyle,
                    draggable: draggable,
...
function TopicDesc(props) {
    ...
    if (!isEditing &&
        controller.run('isBlockEmpty', __assign(__assign({}, props), {
            block: desc.block
        })))
        return null;
...
function LinkStyleEditor(props) {
    ...
    return (createElement(SettingGroup, null,
        ...
        showLinkStyle && (createElement(SettingRow, {
                alignItems: "center"
            },
            createElement(Margin, {
                margin: "0 5px 0 0"
...
function MetadataEditor(props) {
    ...
    var contentEditor = createElement(SettingItem, null,
        createElement(Flex, {
                alignItems: "center"
            },
            createElement(Margin, {
                margin: "0 5px 0 0"
            }, "內容: "+returnNoteContent(getTitle())),
            createElement(InputGroup, null)));
    var questionEditor = createElement(SettingItem, null,
        createElement(Flex, {
                alignItems: "center"
            },
            createElement(Margin, {
    ...
    return (createElement(PanelTabRoot, null,
        createElement(SettingGroup, null,
            createElement(SettingItem, null,
                createElement(Flex, {
                    ...
                    createElement(Margin, {
                        margin: "0 5px 0 0"
                    }, "知識點:"+returnNodeName(getTitle())),
                    createElement(InputGroup, 'fuck'))),
            createElement(SettingItem, null,
                createElement(Flex, {
                        alignItems: "center"
                    },
        ...
        createElement(SettingGroup, null,
            createElement(SettingTitle, null, "子概念"),
...
function RightTopPanelPlugin() {
    ...
    return {
        ...
        renderRightTopPanelTabs: function (props) {
            ...
            var metadataEditorTab = controller.run('renderMetadataEditor', props);
            return [styleEditorTab, themeEditorTab, metadataEditorTab];
        },
        ...
        renderMetadataEditor: function (props) {
            var tProps = {
                id: 'metadata-editor',
                key: 'metadata-editor',
                title: 'Metadata',
                panel: createElement(MetadataEditor, __assign({}, props))
            };
            return createElement(Tab, __assign({}, tProps));
        }
    }
